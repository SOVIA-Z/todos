    ...
    handler: async(ctx,args)=>{
        ...
        const response = await openai.chat.completions.create({
            ...
            messages:[
                {
                    role:"system",
                    content:"Generate 3 to-dos based on the given prompt. Please include a title and description .please return a JSON object in the following format : {todo:[{title:string,description:string}] }"
